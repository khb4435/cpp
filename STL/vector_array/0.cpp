...
//C스타일(char id[10]="robin";)이 아닌 std array로 쓰면 iterator를 쓸수있다는건 아는데 다른 장점이 더 있나요?
//vector에서 예시들었던 nums.begin()이런게 array에서도 가능하다는것
//Array.size()도 하나의 장점이 되겠네요

//array를 굳이 써야할 이유가 있을까요?? vector로 모든경우에 대해서 대체가 가능한것 같아서요. 
...
//random access를 지원한다는건 메모리가 연속된 공간으로 할당된 것!
#include <iostream>
#include <array>
#include <vector>
